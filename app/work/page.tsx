...
export default function WorkPage() {
  return (
    <>
      ...
      />
      <SectionShell variant="ink" className="bg-ink-800" ariaLabel="Sproutflow client work">
        <WorkIndex />
        <div className="mt-12 grid gap-8 border-y border-white/20 py-10 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-8">
            <p className="text-eyebrow uppercase text-accent-300">Not sure which project is closest?</p>
            <h2 className="mt-4 font-display text-display-md text-cream-300">Show me what customers see now.</h2>
          </div>
