  ...
  return (
    <>
      ...
      <header className="border-b border-primary-100 bg-gradient-to-br from-white via-primary-50/60 to-accent-50/40">
        <div className="mx-auto max-w-5xl px-4 py-24 md:px-8 md:py-28">
          ...
          <h1 className="max-w-3xl break-words text-4xl font-display font-bold leading-tight text-gray-900 md:text-6xl">
      ...
      <main className="bg-white">
        <section className="mx-auto grid max-w-6xl gap-6 px-4 py-16 md:grid-cols-2 md:px-8 md:py-20">
        ...
        <section className="mx-auto max-w-5xl px-4 pb-20 md:px-8">
          <div className="rounded-2xl border border-primary-200 bg-primary-50 p-6 md:p-8">
            <h2 className="mb-3 text-2xl font-display font-bold text-gray-900">
